...
*/
void      TMP117::setAlertCallback (void (*alert_callback)(void), uint8_t pin) {
  alert_pin = pin;
  pinMode(pin, INPUT_PULLUP);
   
  attachInterrupt(digitalPinToInterrupt(pin), alert_callback, FALLING ); // Sets up pin 2 to trigger "alert" ISR when pin changes H->L and L->H
}
